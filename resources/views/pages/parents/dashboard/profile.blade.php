                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="box box-inverse bg-img" data-overlay="2">
                                            ...
                                            <div class="box-body text-center  pb-50">
                                                ...
                                                <h4 class="mt-2 mb-0">{{ $information->Name_Father }}</h4>
                                                <span>{{ $information->email }}</span>
                                                <h6 class="widget-user-desc">ولي أمر</h6>

                                            </div>

                                            <ul class="box-body flexbox flex-justified text-center" data-overlay="4">
                                                <li>
                                                    <span class="opacity-60">الوظيفة</span><br>
                                                    <span >{{ $information->Job_Father }}</span>
                                                </li>
                                                <li>
                                                    <span class="opacity-60">رقم الهوية</span><br>
                                                    <span >{{ $information->National_ID_Father }}</span>
                                                </li>
                                                <li>
                                                    <span class="opacity-60">العنوان</span><br>
                                                    <span >{{ $information->Address_Father }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <form action="{{ route('profile.update', $information->id) }}"
                                                    method="post">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <p class="text-muted mb-0">
                                                                <input type="text" name="Name_Father"
                                                                    value="{{ $information->Name_Father }}" class="form-control">
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <hr>
